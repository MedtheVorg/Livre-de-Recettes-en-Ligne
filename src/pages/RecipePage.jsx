      ...
      <div className="">
        ...
        <div className="flex justify-between flex-wrap items-center ">
            ...
            <div className="flex gap-4">
              <button onClick= {() => navigate(`/RecipeUpdatePage/${recipe.id}`)} className="bg-customGreen text-white rounded uppercase duration-200 hover:text-customBlack hover:bg-customYellow w-36 h-12 mt-2">Update Recipe</button>            
