    ...
    <div className="">
      ...
      <div className="flex justify-between flex-wrap items-center ">
          ...
          <div className="flex gap-4">
            ...
            <Link to={`/recipes`} onClick={handlDeleteRecipe} className="p-3.5 text-center bg-customGreen text-white rounded uppercase duration-200 hover:text-customBlack hover:bg-customYellow w-36 h-12 mt-2">Delete Recipe</Link>
          </div>
      </div>
      </div>
