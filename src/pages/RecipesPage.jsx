          ...
          <div className='h-80 mt-4 text-customWhite rounded-2xl bg-cover bg-center flex items-center px-3 mb-10' style={{ backgroundImage: 'url(https://premium-html-templates.mgtechnologies.co.in/mg-organics/assets/images/products/side-content-category-img1.png)'}}>
            ...
            <main className='lg:col-span-7 col-span-full mx-2 p-4'>
              <div className='flex justify-end'>
                <Link to={'/recipe/add'} className="bg-customGreen mb-5 hover:bg-customYellow  text-white py-2 px-4 rounded-2xl">Add Your Own Recipie</Link>
              </div>
                    ...
                    {recipes.filter((recipe) => recipe.category === selectedCategory).map((recipe,index) => (
                      ...
                      src={recipe.imageUrl} alt="" />
                        ...
                        <div className='flex gap-4 flex-col justify-center'>
                          ...
                          <Link to={`/recipe/${recipe.id}`} className="bg-customGreen w-full hover:bg-customYellow  text-white py-2 px-4 rounded-2xl">Show More</Link>
                        </div>
                      </div>
                    ))}
                </div>
