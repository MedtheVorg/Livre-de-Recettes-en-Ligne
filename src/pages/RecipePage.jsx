  ...
  return (
    <div className="container mx-auto my-8 px-8">
      <div className="">
        ...
        <div className="flex justify-between flex-wrap items-center ">
          ...
          <div className="flex gap-4">
            <Link
              to={`/recipe/update/${recipeId}`}
              className="p-3.5 text-center bg-customGreen text-white rounded uppercase duration-200 hover:text-customBlack hover:bg-customYellow w-36 h-12 mt-2"
            >
              Update Recipe
            </Link>
            <Link
              to={`/recipes`}
              onClick={handlDeleteRecipe}
              className="p-3.5 text-center bg-customGreen text-white rounded uppercase duration-200 hover:text-customBlack hover:bg-customYellow w-36 h-12 mt-2"
            >
              Delete Recipe
            </Link>
      ...
      <div className=" my-4 min-w-3 rounded relative">
        ...
        <div className="absolute bottom-0 right-0 left-0 w-full text-green-900 bg-yellow-500 text-base p-4 text-xl flex p-1.75 items-center justify-around">
          <h5 className="">
              ...
              {recipe?.instructions?.map((e, i) => {
                return (
                  <li className="text-1xl mb-6" key={i}>
                    <span className="text-1xl mb-3 font-bold px-3 py-1.5 text-green-900 bg-yellow-500 rounded-md">
                      {i + 1}
                    </span>
                    - {e}
                  </li>
